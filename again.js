...
const again = (player, ghost01, ghost02, ghost03, ghost04, pacman, arr) => {
  ...
  } // ahol eddig szellem volt, visszarakjuk azt ami eredetileg ott volt
  ghost01.x = 7; // visszaállítjuk a szellemek adatait a kezdetire
  ghost01.y = 8;
  ghost01.prev = 0;
  ghost01.start = ['', 'right', 'up'];
  ghost01.count = 0;
  if (ghost02.prev !== 8) {
